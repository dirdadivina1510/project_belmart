...
<div class="category-page">
    <section class="category-header">
        <div class="category-header-content">
            ...
            <h1>Sosis</h1>
            <p>Aneka sosis ayam & sapi berkualitas lezat, gurih, dan siap diolah kapan saja.</p>
        </div>
    ...
    <div class="category-toolbar">
        ...
        <div class="category-actions">
            <form action="{{ route('products.sosis') }}" method="GET" class="sort-form">
                <label for="sort-sosis">Urutkan:</label>
                <select name="sort" id="sort-sosis" onchange="this.form.submit()">
    ...
    <div class="category-products">
        @forelse($products as $product)
            <div class="category-product-item">
                <div class="category-product-image">
                    ...
                    @else
                        <div class="product-no-image"><i class="fa-solid fa-hotdog"></i></div>
                    @endif
                </div>
        ...
        @empty
            <div style="grid-column:1/-1; text-align:center; padding:70px 20px;">
                ...
                <h3 style="color:#5a7252;">Belum ada produk sosis</h3>
