...
<div class="category-page">
    <section class="category-header">
        <div class="category-header-content">
            ...
            <h1>For Kids</h1>
            <p>Produk olahan makanan beku spesial anak-anak dengan bentuk lucu dan gizi seimbang.</p>
        </div>
    ...
    <div class="category-toolbar">
        ...
        <div class="category-actions">
            <form action="{{ route('products.for-kids') }}" method="GET" class="sort-form">
                <label for="sort-kids">Urutkan:</label>
                <select name="sort" id="sort-kids" onchange="this.form.submit()">
    ...
    <div class="category-products">
        @forelse($products as $product)
            <div class="category-product-item">
                <div class="category-product-image">
                    ...
                    @else
                        <div class="product-no-image"><i class="fa-solid fa-child-reaching"></i></div>
                    @endif
                </div>
        ...
        @empty
            <div style="grid-column:1/-1; text-align:center; padding:70px 20px;">
                ...
                <h3 style="color:#5a7252;">Belum ada produk for kids</h3>
